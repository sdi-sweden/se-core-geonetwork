    ...
    public HealthCheck create(final ServiceContext context) {
        return new HealthCheck("Csw GetRecords") {
            ...
            protected Result check() throws Exception {
                try {
                    LocalServiceRequest request = LocalServiceRequest.create("local://csw?request=GetRecords&service=CSW&MaxRecords=1&constraintlanguage=FILTER&version=2.0.2&resulttype=results&typeNames=gmd:MD_Metadata");
