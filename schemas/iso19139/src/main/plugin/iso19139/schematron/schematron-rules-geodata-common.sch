...
-->
  <sch:title xmlns="http://www.w3.org/2001/XMLSchema">Nationell metadataprofil 3.1 för alla metadata</sch:title>
...
<!-- 			<sch:report test="$accessConstraints_present">$accessConstraints_present:
              <sch:value-of select="$accessConstraints_present"/>
            </sch:report>
			<sch:report test="$otherConstraints">$otherConstraints:
